...
(custom-set-faces
 ...
 '(fill-column-indicator ((t (:inherit shadow :stipple nil :foreground "magenta" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal))))
