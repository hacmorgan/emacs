...
(yas-define-snippets 'cc-mode
                     '(("fn" "/** @brief $5\n    ${3:$(yasnippet-radical-snippets--c++-doxy-docstring yas-text (yas-field-value 2) (yas-field-value 1) t)}\n*/\n${1:type} ${2:name}(${3:args})${4: const};\n${0:$$(let ((beg yas-snippet-beg)\n            (end yas-snippet-end))\n	(yas-expand-snippet\n	  (buffer-substring-no-properties beg end) beg end\n          (quote ((yas-indent-line nil) (yas-wrap-around-region nil))))\n        (delete-trailing-whitespace beg (- end 1)))}" "C/C++ Doxygen Function declaration" nil
                        ("radical")
                        nil "/home/hamish/.emacs.d/elpa/yasnippet-radical-snippets-20210915.1309/snippets/cc-mode/fn_decl_doxygen" nil nil)))
